...
# Register your models here.55555555cc
...
class NewAssetAdmin(admin.ModelAdmin):#定义模型的显示模式
    ...
    approve_selected_new_assets.short_description = "批准选择的新资产"#是admin的action提示显示中文
